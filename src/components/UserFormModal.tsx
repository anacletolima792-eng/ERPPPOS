    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 backdrop-blur-xs p-3 sm:p-4">
      ...
      >
        <div className="px-5 py-4 border-b border-slate-200 flex items-center justify-between bg-slate-50">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium">Controle de acesso e papéis</p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div>
            <label className="text-xs font-bold text-slate-700 block mb-1">Nome do Operador *</label>
            <input
              type="text"
              required
              ...
              className="w-full px-3.5 py-2.5 text-xs font-semibold bg-slate-50 border border-slate-300 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>

          <div>
            <label className="text-xs font-bold text-slate-700 block mb-1">E-mail do Usuário *</label>
            <input
              type="email"
              required
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs font-bold text-slate-700 block mb-1">Papel / Perfil *</label>
              <select
            ...
            <div>
              <label className="text-xs font-bold text-slate-700 block mb-1">PIN de Acesso (4 Dígitos)</label>
              <input
                type="text"
                maxLength={6}
                ...
                placeholder="1234"
                className="w-full px-3 py-2 text-xs font-mono font-bold bg-slate-50 border border-slate-300 rounded-xl focus:bg-white focus:outline-none"
              />
            </div>
          </div>
